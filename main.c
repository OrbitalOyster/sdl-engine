...
int main() {
  ...
  player = createEntity(162, 145, 48, 48);
  ...
  //box = createEntity(120, 168, 32, 32);
  box->collisionId = 4;
  box->collisionMask = 3;
  box->tag = 5;
  ...
  registerCollisionCallback(1, 5, getPushedCallback); // Box -> Player
  registerCollisionCallback(4, 10, slideCallback); // Player -> Box
