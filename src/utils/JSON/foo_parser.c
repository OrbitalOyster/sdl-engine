...
void set_parser_err(struct Foo_parser *parser, char *err, ...) {
...
static int get_next_char_F(struct Foo_parser *parser, int skip_whitespaces) {
...
static int get_next_char_S(struct Foo_parser *parser, int skip_whitespaces) {
...
static int read_number(struct Foo_parser *parser,
                       int (*get_next_char)(struct Foo_parser *, int)) {
  unsigned int n = 0;
...
static void read_true(struct Foo_parser *parser,
                      int (*get_next_char)(struct Foo_parser *, int)) {
...
static void read_false(struct Foo_parser *parser,
                       int (*get_next_char)(struct Foo_parser *, int)) {
...
static void read_null(struct Foo_parser *parser,
                      int (*get_next_char)(struct Foo_parser *, int)) {
...
static void read_comma_or_brace(struct Foo_parser *parser,
...
static void read_comma_or_bracket(struct Foo_parser *parser,
                                  int (*get_next_char)(struct Foo_parser *,
                                                       int)) {
...
static struct TokenMap *parse_object(struct Foo_parser *parser,
                                     int (*get_next_char)(struct Foo_parser *,
                                                          int)) {
  INFO("Parsing object...");
...
static struct TokenArray *parse_array(struct Foo_parser *parser,
                                      int (*get_next_char)(struct Foo_parser *,
                                                           int)) {
  INFO("Parsing array...");
...
struct Token *parse_JSON_file(char *filename) {
  struct Foo_parser *parser = create_JSON_parser();
